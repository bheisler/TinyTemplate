                ...
                Instruction::Value(path) => {
                    ...
                    match value_to_render {
                        ...
                        _ => return Err(RenderError {
                            msg: format!("Expected a printable value for path '{}' but found array or object.", path_to_str(path)),
                        })
                    };
                    program_counter += 1;
                }
